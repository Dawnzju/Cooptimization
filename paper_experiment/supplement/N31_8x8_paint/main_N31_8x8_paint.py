...
for i in range(0,150):
    ...
    cur_json=handle_my_output('./task graph/N31_fmradio.tgff',Tasks_position_current_solution,cur_task_graph,computation_ability)
    dir_name='./paint_json/'
    if(os.path.exists(dir_name)==False):
        os.makedirs(dir_name)
    with open(dir_name+'fmradio_8x8_AIR1_iter_'+str(i)+'.json',"w") as f3:
