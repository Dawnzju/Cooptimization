...
computation_ability=CVB_method(execution=execution[1:],V_machine=0.75,num_of_rows=N)
...
for i in range(0,150):
    ...
    cur_json=handle_my_output('./task graph/N22_audiobeam.tgff',Tasks_position_current_solution,cur_task_graph,computation_ability)
    dir_name='./paint_json/'
    if(os.path.exists(dir_name)==False):
        os.makedirs(dir_name)
    with open(dir_name+'audiobeam_8x8_AIR1_V0.75_iter_'+str(i)+'.json',"w") as f3:
